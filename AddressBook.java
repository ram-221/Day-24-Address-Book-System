...
public class AddressBook {
	...
	public void readData() {
		...
		if(duplicate == false) {
			Person contact = new Person(first , last , add , city , state , zip , phoneNo , email);
	...
	public void searchPersonByState(String state) {
		ArrayList<Person> list = (ArrayList<Person>) contactBook.stream().filter(contactName -> contactName.getState().equals(state))
	...
	public void sortByFirstName() {
		ArrayList<Person>  sortedList = (ArrayList<Person>) contactBook.stream().sorted((type1, type2) -> (type1.getFirstName().compareTo(type2.getFirstName()))).collect(Collectors.toList());
